...
export function buildCountryFaqGroups({ country, bestPlan, networks, coverage, plans = [] }) {
  ...
  return [
    { id: "plans", label: "Plans and pricing", summary: "Cost, data and validity", questions: [
      { number: "01", question: `Which verified eSIM offer is shown for ${country}?`, answer: `${bestPlan.brand} ${bestPlan.product} is the verified offer currently displayed: ${bestPlan.dataLabel}, ${bestPlan.days} days and a published starting price of $${bestPlan.price.toFixed(2)}. Saily is prioritized because its official destination page provides the source data.` },
      { number: "02", question: `What is the verified starting price for a travel eSIM in ${country}?`, answer: `The displayed Saily starter plan begins at $${lowestPrice.toFixed(2)} for 1 GB over 7 days. This price was checked on August 24, 2026; confirm the final checkout price because taxes, currency and promotions can change.` },
